...
<lang pt-BR>
<head>
	<title>SIG WEB - Densidade Pop.</title>
	<meta charset = "UTF-8">
...
<body>
	...
	<script>
		...
		var map = L.map('mapid', {zoomDelta: 0.25, zoomSnap:0}).setView([-22.278931, -49.108887],6);
		...
		map.flyToBounds(bounds,{animate: true, duration: 10}); //animate e duration são heranças de zoom option e pam option
		...
		map.attributionControl.addAttribution(' | Dados sensitários: <a href="http://www.seade.gov.br/">IBGE/Fundação SEADE</a>');
