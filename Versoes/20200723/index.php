...
<body style="overflow: auto";>
	<div style="display:flex">
		...
		<a id="btn1" href="seadeWMS.php" style="background-color:darkred; border :1px solid white; border-radius: 20px; color:white; text-align:center; text-decoration:none; padding: 15px 0; margin: 0px; display:inline-block; flex: 1; width: 33.3%">WMS</a>
	</div>
	<div id="mapid"></div>
